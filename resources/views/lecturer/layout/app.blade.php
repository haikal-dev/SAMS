...
<html lang="en">
    <head>
        ...
        <title>@yield('title') - SAMS for Lecturer</title>
        ...
        <!-- Timeline CSS -->
        <link href="{{env('APP_URL')}}/assets/startmin/css/timeline.css" rel="stylesheet">

        <!-- Custom CSS -->
        <link href="{{env('APP_URL')}}/assets/startmin/css/startmin.css" rel="stylesheet">

        <!-- Morris Charts CSS -->
        <link href="{{env('APP_URL')}}/assets/startmin/css/morris.css" rel="stylesheet">
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                <div class="navbar-header">
                    <a class="navbar-brand" href="{{$config->homeUrl}}">SAMS</a>
                </div>
                ...
                <ul class="nav navbar-nav navbar-left navbar-top-links">
                    <li><a href="{{$config->homeUrl}}"><i class="fa fa-home fa-fw"></i> Home</a></li>
                </ul>
                ...
                <ul class="nav navbar-right navbar-top-links">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            <i class="fa fa-user fa-fw"></i> {{$config->user}} <b class="caret"></b>
                        </a>
                        <ul class="dropdown-menu dropdown-user">
                            <li><a href="#"><i class="fa fa-user fa-fw"></i> User Profile</a>
                            </li>
                            <li><a href="{{$config->homeUrl}}/settings"><i class="fa fa-gear fa-fw"></i> Settings</a>
                            </li>
                            <li class="divider"></li>
